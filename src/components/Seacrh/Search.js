...
function Search() {
    ...
    // Função para filtrar a lista de usuários com base no termo de busca
    const filterUsers = () => {
    ...
    // Chama a função de filtro sempre que o termo de busca muda
    React.useEffect(() => {
        filterUsers();
    }, [searchTerm]);
    ...
    return (
        ...
        <SearchComponent>
             <div>
                ...
                />
                <ImgSearch src={searchIcon}/></DivInput>
